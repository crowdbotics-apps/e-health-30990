"""e_health_30990 URL Configuration
...
admin.site.site_header = "E health"
admin.site.site_title = "E health Admin Portal"
admin.site.index_title = "E health Admin"

# swagger
api_info = openapi.Info(
    title="E health API",
    default_version="v1",
    description="API documentation for E health App",
)
